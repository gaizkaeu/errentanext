...
var preferredCharsets = __webpack_require__(5179)
var preferredEncodings = __webpack_require__(8617)
var preferredLanguages = __webpack_require__(901)
var preferredMediaTypes = __webpack_require__(8211)
...
var _addPathPrefix = __webpack_require__(7407);
...
var _parsePath = __webpack_require__(2774);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
var _removeTrailingSlash = __webpack_require__(6712);
var _addPathPrefix = __webpack_require__(7407);
var _addPathSuffix = __webpack_require__(9551);
...
var _normalizeLocalePath = __webpack_require__(1199);
var _removePathPrefix = __webpack_require__(8226);
var _pathHasPrefix = __webpack_require__(763);
function getNextPathnameInfo(pathname, options) {
    var _nextConfig;
    const { basePath , i18n , trailingSlash  } = (_nextConfig = options.nextConfig) != null ? _nextConfig : {};
...
var negotiator = __webpack_require__(7462);
...
;// CONCATENATED MODULE: ./node_modules/next-intl/dist/src/server/resolveLocale.js
...
function resolveLocale(i18n, requestHeaders, requestCookies, pathname) {
    let locale, domain;
...
;// CONCATENATED MODULE: ./node_modules/next-intl/dist/src/middleware.js
...
function createIntlMiddleware(config) {
    return function middleware(request) {
        ...
        function next() {
            return server.NextResponse.next(getResponseInit());
        }
        function redirect(url) {
            return server.NextResponse.redirect(new URL(url, request.url));
        }
        let response;
        if (isRoot) {
            ...
            const pathLocale = config.locales.find((cur) => request.nextUrl.pathname.startsWith(`/${cur}`));
...
var _detectDomainLocale = __webpack_require__(8824);
var _formatNextPathnameInfo = __webpack_require__(1718);
var _getHostname = __webpack_require__(8502);
var _getNextPathnameInfo = __webpack_require__(5674);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|::1|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
var _responseCookies = __webpack_require__(7863);
...
var _serialize = __webpack_require__(5596);
class RequestCookies {
    _parsed = new Map();
    constructor(requestHeaders){
        this._headers = requestHeaders;
...
var _cookies = __webpack_require__(4437);
const INTERNALS = Symbol("internal request");
...
const serverExports = {
  NextRequest: (__webpack_require__(7953)/* .NextRequest */ .Im),
  NextResponse: (__webpack_require__(7057)/* .NextResponse */ .x),
  userAgentFromString: (__webpack_require__(5559)/* .userAgentFromString */ .Nf),
  userAgent: (__webpack_require__(5559)/* .userAgent */ .WE),
}
...
//# sourceMappingURL=middleware.js.map;
  export default (function () {
    ...
    {"name":"src/middleware","staticRoutes":[],"dynamicRoutes":[{"page":"/[lang]","regex":"^/([^/]+?)(?:/)?$","routeKeys":{"lang":"lang"},"namedRegex":"^/(?<lang>[^/]+?)(?:/)?$"},{"page":"/[lang]/account/sign_in","regex":"^/([^/]+?)/account/sign_in(?:/)?$","routeKeys":{"lang":"lang"},"namedRegex":"^/(?<lang>[^/]+?)/account/sign_in(?:/)?$"},{"page":"/[lang]/dashboard","regex":"^/([^/]+?)/dashboard(?:/)?$","routeKeys":{"lang":"lang"},"namedRegex":"^/(?<lang>[^/]+?)/dashboard(?:/)?$"},{"page":"/[lang]/organizations","regex":"^/([^/]+?)/organizations(?:/)?$","routeKeys":{"lang":"lang"},"namedRegex":"^/(?<lang>[^/]+?)/organizations(?:/)?$"},{"page":"/[lang]/organizations/[id]","regex":"^/([^/]+?)/organizations/([^/]+?)(?:/)?$","routeKeys":{"lang":"lang","id":"id"},"namedRegex":"^/(?<lang>[^/]+?)/organizations/(?<id>[^/]+?)(?:/)?$"}],"nextConfig":{"basePath":""}}
  )