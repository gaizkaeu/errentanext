...
export const OrganizationExploreMap = () => {
    ...
    return (
        <div className="grid grid-cols-7 gap-4">
            <div className="max-lg:hidden lg:col-span-2 flex flex-col gap-2 items-center mt-24 p-3">
                <SearchBar searchParams={search} setSearchParams={setSearch}>
                    <TextFilter key_name="name" key="name" title={"Buscar por nombre"} />
                    <LocationFilter />
                </SearchBar>
                {currentData && currentData.map((org: Organization) => (
            ...
            <div className="relative col-span-7 lg:col-span-5">
                <div className='absolute inset-x-0 top-24 z-10'>
                    <div className='flex items-center bg-white p-2 rounded-xl w-fit mx-auto gap-2'>
