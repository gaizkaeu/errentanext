...
import useViewportSize from "@/lib/utils/use-viewport-size";
    ...
    <>
      ...
      <AnimatePresence>
        {openPopover && (
          <>
            ...
            >
              <div
                className={`rounded-t-4xl -mb-1 flex h-7 w-full items-center justify-center border-t border-gray-200 dark:border-midnight-700 bg-white dark:bg-midnight-800`}
              >
                <div className="-mr-1 h-1 w-6 rounded-full bg-gray-300 transition-all group-active:rotate-12" />
                <div className="h-1 w-6 rounded-full bg-gray-300 transition-all group-active:-rotate-12" />
              </div>
              <div className="flex min-h-[150px] w-full items-center justify-center overflow-hidden bg-white dark:bg-midnight-800 align-middle shadow-xl">
                {content}
              </div>
            </motion.div>
            <motion.div
      ...
      >
        ...
        <PopoverPrimitive.Content
          sideOffset={4}
          align={align}
          className="z-20 hidden animate-slide-up-fade items-center rounded-md border border-gray-200 dark:border-midnight-700 bg-white dark:bg-midnight-800 drop-shadow-lg md:block"
        >
          {content}
        </PopoverPrimitive.Content>
      </PopoverPrimitive.Root>
