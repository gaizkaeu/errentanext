...
export default function Modal({
  ...
  const mobileModalRef = useRef<any>();
    ...
    <AnimatePresence>
      {showModal && (
          <div className="absolute">
            ...
            >
              <div
                className={`h-7 ${bgColor} rounded-t-4xl -mb-1 flex w-full items-center justify-center border-t border-gray-200 dark:bg-gray-700`}
              >
